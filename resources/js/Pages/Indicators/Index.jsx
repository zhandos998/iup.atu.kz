...
export default function Indicators({ category, indicators }) {
    ...
    return (
        <AppLayout>
            <h1 className="text-2xl font-bold text-blue-600 mb-6">{category.name}</h1>
                            ...
                            <tr key={ind.id}>
                                ...
                                <td className="p-2 border">
                                    <input
                                        ...
                                        onChange={(e) => setData(`plan_${ind.id}`, e.target.value)}
                                    />
                                </td>
                                <td className="p-2 border">
                                    <input
                                        type="text"
                                        className="border rounded px-2 py-1 w-full"
                                        onChange={(e) => setData(`fact_${ind.id}`, e.target.value)}
                                    />
                                </td>
                                <td className="p-2 border">
                                    <input
                                        type="file"
                                        multiple
                                        onChange={(e) => setData(`files_${ind.id}`, e.target.files)}
                                    />
                                </td>
